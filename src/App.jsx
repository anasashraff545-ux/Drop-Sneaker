        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2 text-neutral-400 text-sm">
              ...
              <a href="https://wa.me/20122930934" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                01229309934
              </a>
            </div>
            <div className="flex items-center gap-2 text-neutral-400 text-sm">
              <MessageCircle className="w-4 h-4 text-green-500" />
              <a href="https://wa.me/201226351839" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                01226351839
              </a>
            </div>
          </div>
